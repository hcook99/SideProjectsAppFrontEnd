...
import { ListItem, FormControlLabel, Typography, Checkbox, withStyles, Collapse, Button } from '@material-ui/core'
...
function ListOfCheckBoxes(props){
            ...
            <ListItemCheckbox key={i}>
                <FormControlLabel
                    control={
                        ...
                        label={<FilterStyleTypography style={{fontSize: '0.8em'}}>{checkBoxValue}</FilterStyleTypography>}
                    />
            </ListItemCheckbox>
        );
    }
    ...
    return (
        <div>
            <ListItem>
                <FilterStyleTypography style={{fontWeight: 'bold', fontSize: '0.9em'}}>
                    {props.categoryTitle}
                ...
                (
                    <div>
                        <Collapse in={showMore}>
                            {listOfCheckBoxTemp.slice(3)}
                        </Collapse>
                        <ShowMoreButton onClick={handleChange} disableRipple={true}>
